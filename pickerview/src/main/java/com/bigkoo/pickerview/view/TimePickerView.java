...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            ...
            btnSubmit.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    if (motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                        btnSubmit.setTextColor(mPickerOptions.textColorConfirmClick);
            ...
            btnCancel.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    if (motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                        btnCancel.setTextColor(mPickerOptions.textColorConfirmClick);
                    } else if (motionEvent.getAction() == MotionEvent.ACTION_UP) {
                        btnCancel.setTextColor(mPickerOptions.textColorConfirm);
                    }else if ( motionEvent.getAction() == MotionEvent.ACTION_CANCEL){
                        btnCancel.setTextColor(mPickerOptions.textColorConfirm);
                    }
                    return false;
    ...
    private void initWheelTime(LinearLayout timePickerView) {
        ...
        wheelTime.setTextColorCenter(0xFF000000);
        wheelTime.isCenterLabel(mPickerOptions.isCenterLabel);
        final View yearView = wheelTime.getView().findViewById(R.id.year);
        final View monthView = wheelTime.getView().findViewById(R.id.month);
        final View dayView = wheelTime.getView().findViewById(R.id.day);
        yearView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus){
                    wheelTime.setYearTextColorCenter(mPickerOptions.textColorCenter);
                }else{
                    wheelTime.setYearTextColorCenter(0xFFa8a8a8);
                }
            }
        });
        monthView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus){
                    wheelTime.setMonthTextColorCenter(mPickerOptions.textColorCenter);
                }else{
                    wheelTime.setMonthTextColorCenter(0xFFa8a8a8);
                }
            }
        });
        dayView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus){
                    wheelTime.setDayTextColorCenter(mPickerOptions.textColorCenter);
                }else{
                    wheelTime.setDayTextColorCenter(0xFFa8a8a8);
                }
            }
        });
    ...
    public void onClick(View v) {
        if (isFastTimeClick()) {
            ...
            if (tag.equals(TAG_SUBMIT)) {
                ...
                mPickerOptions.timeSelectChangeListener.cancelClick();
    ...
    public boolean isFastTimeClick() {
        boolean flag = false;
