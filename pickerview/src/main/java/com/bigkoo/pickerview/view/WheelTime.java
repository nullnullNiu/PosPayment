...
public class WheelTime {
    ...
    private static final int YEAR_END_INDEX = 200;
    ...
    public void setTimeListened() {
            ...
            public boolean onKey(View view, int i, KeyEvent keyEvent) {
                ...
                switch (keyEvent.getKeyCode()) {
                    case KeyEvent.KEYCODE_DPAD_UP:
                        if( (YEAR_START_INDEX) < index) {
                            index --;
                            wv_year.setCurrentItem(index);
                            wv_year.getOnItemSelectedListener().onItemSelected(index);
                        }
                        break;
                    case KeyEvent.KEYCODE_DPAD_DOWN:
                        if(YEAR_END_INDEX > index) {
                            index ++;
                            wv_year.setCurrentItem(index);
                            wv_year.getOnItemSelectedListener().onItemSelected(index);
                        }
        ...
        wv_month.setOnKeyListener(new View.OnKeyListener() {
            ...
            public boolean onKey(View view, int i, KeyEvent keyEvent) {
                ...
                switch (keyEvent.getKeyCode()) {
                    case KeyEvent.KEYCODE_DPAD_UP:
                        if( DEFAULT_START_MONTH -1< index) {
                            index --;
                            wv_month.setCurrentItem(index);
                            wv_month.getOnItemSelectedListener().onItemSelected(index);
                        }
                        break;
                    case KeyEvent.KEYCODE_DPAD_DOWN:
                        if(DEFAULT_END_MONTH > index) {
                            index ++;
                            wv_month.setCurrentItem(index);
                            wv_month.getOnItemSelectedListener().onItemSelected(index);
                        }
        ...
        wv_day.setOnKeyListener(new View.OnKeyListener() {
            ...
            public boolean onKey(View view, int i, KeyEvent keyEvent) {
                ...
                switch (keyEvent.getKeyCode()) {
                    case KeyEvent.KEYCODE_DPAD_UP:
                        if( DEFAULT_START_DAY -1 < index) {
                            index --;
                            wv_day.setCurrentItem(index);
                        }
                        break;
                    case KeyEvent.KEYCODE_DPAD_DOWN:
                        if(DEFAULT_END_DAY > index) {
                            index ++;
                            wv_day.setCurrentItem(index);
                        }
                }
...
//        wv_year.setBackgroundResource(R.drawable.gridview_item_select);
//        wv_month.setFocusable(true);
//        wv_month.setBackgroundResource(R.drawable.gridview_item_select);
//        wv_day.setFocusable(true);
//        wv_day.setBackgroundResource(R.drawable.gridview_item_select);
...
//                maxItem = endD;
    ...
    public void setYearContentTextSize(int textSize) {
        wv_year.setTextSize(textSize);
    }
    public void setMonthContentTextSize(int textSize) {
        wv_year.setTextSize(textSize);
    }
    public void setDayContentTextSize(int textSize) {
        wv_year.setTextSize(textSize);
    }
    ...
    public void setYearTextColorCenter(int colorCenter) {
        wv_year.setTextColorCenter(colorCenter);
    }
    public void setMonthTextColorCenter(int colorCenter) {
        wv_month.setTextColorCenter(colorCenter);
    }
    public void setDayTextColorCenter(int colorCenter) {
        wv_day.setTextColorCenter(colorCenter);
    }
