...
public class PickerOptions {
    ...
    //constant
    private static final int PICKER_VIEW_BTN_COLOR_NORMAL = 0xFF9A9EA2;
    private static final int PICKER_VIEW_BTN_COLOR_CLICK = 0xFF0C7EF3;
    private static final int PICKER_VIEW_BG_COLOR_TITLE = 0xFFf5f5f5;
    private static final int PICKER_VIEW_COLOR_TITLE = 0xFF2F3337;
    ...
    public int textColorConfirmClick = PICKER_VIEW_BTN_COLOR_CLICK;//确定按钮点击颜色
    ...
    public int textColorCenter = 0xFF1e90ff; //分割线之间的文字颜色
    public int dividerColor = 0xFF1e90ff; //分割线的颜色
